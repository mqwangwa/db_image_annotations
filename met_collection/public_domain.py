...
if __name__ == "__main__":
    df_original = pd.read_excel("met_collection/MetObjects.xlsx")
    ...
    cols_to_keep = ["Object Number", "Object ID", "Period", "Classification", "Culture", "Medium"]
    df_filtered = df_filtered[cols_to_keep]
    df_filtered.to_excel("met_collection/FilteredObjects.xlsx", index=False)